...
<html lang="en">
  ...
  <body>
    ...
    <?php
            ...
            // Redirrect to home page is user isn't logged in
            ...
            $db = new databaseHelper();     // create db object to handle database interractions

            // Get all pending appointments from database
            $appointments = $db->getPendingAppointments($_SESSION['logged_in_client']['id']);
				...
				<?php else: ?>
					<li class="nav-item dropdown">
						...
						<div class="dropdown-menu" aria-labelledby="navbarDropdown">
							<a class="dropdown-item" href="appointments.php">My Appointments</a>
